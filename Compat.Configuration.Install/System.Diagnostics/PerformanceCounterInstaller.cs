...
namespace System.Diagnostics
{
    public class PerformanceCounterInstaller : ComponentInstaller
    {
        ...
        private UninstallAction uninstallAction = UninstallAction.Remove;
        ...
        public override void CopyFromComponent(IComponent component)
        {
            ...
            if (Environment.OSVersion.Platform == PlatformID.Win32NT)
            {
                ...
                if (PerformanceCounterCategory.Exists(CategoryName, machineName))
                {
                    ...
                    try
                    {
                        if (machineName == "." || String.Compare(machineName, Environment.MachineName, StringComparison.OrdinalIgnoreCase) == 0)
                        {
