    ...
    public class AssemblyInstaller : Installer
    {
        ...
        public override void Commit(IDictionary savedState)
        {
            ...
            try
            {
                ...
                {
                    using (var filestream = new FileStream(installStatePath, FileMode.Open, FileAccess.Read))
                    {
                        ...
                        using (var reader = XmlReader.Create(installStatePath, settings))
                        {
                            NetDataContractSerializer serializer = new NetDataContractSerializer();
                            savedState = (IDictionary)serializer.ReadObject(reader);
                        }
                    }
                }
            }
        ...
        public override void Install(IDictionary savedState)
        {
            ...
            {
                using (var stream = new FileStream(GetInstallStatePath(Path), FileMode.Create))
                {
